...
namespace AtomicCore.Integration.MysqlDbProvider
{
    ...
    /// Mssql语句解析结果集
    /// </summary>
    internal sealed class MysqlSentenceResult : ResultBase
    {
        #region Variable
        ...
        private List<MysqlSelectField> _sqlSelectFields = null;
        ...
        private List<MysqlParameterDesc> _sqlQuerylParameters = null;
        ...
        /// Sql查询中出现的需要查询的字段
        /// </summary>
        public IEnumerable<MysqlSelectField> SqlSelectFields
        {
            get
            {
        ...
        /// Sql查询中出现的参数集合
        /// </summary>
        public IEnumerable<MysqlParameterDesc> SqlQuerylParameters
        {
            get
            {
        ...
        /// </summary>
        /// <returns></returns>
        public static MysqlSentenceResult Create()
        {
            return new MysqlSentenceResult();
        }
        ...
        public void SetSelectField(MysqlSelectField field)
        {
            if (field == null)
            {
            ...
            else
            {
                ...
                {
                    this._sqlSelectFields = new List<MysqlSelectField>();
                }
        ...
        public void SetSelectField(IEnumerable<MysqlSelectField> fields)
        {
        ...
        public void SetWhereCondition(string whereText, IEnumerable<MysqlParameterDesc> parameters = null)
        {
            ...
            if (parameters != null)
            {
                ...
                {
                    this._sqlQuerylParameters = new List<MysqlParameterDesc>();
                }
