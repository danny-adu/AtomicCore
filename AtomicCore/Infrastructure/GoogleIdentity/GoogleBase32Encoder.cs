...
{
    /// <summary>
    /// Encodes text into Base32
    /// </summary>
    /// <remarks>
    /// Taken from http://www.codeproject.com/Articles/35492/Base32-encoding-implementation-in-NET
    /// </remarks>
    internal class GoogleBase32Encoder
    {
        ...
        /// 构造函数
        /// </summary>
        public GoogleBase32Encoder() : this(DEF_ENCODING_TABLE, DEF_PADDING) { }

        /// <summary>
        /// 构造函数
        /// </summary>
        /// <param name="padding"></param>
        public GoogleBase32Encoder(char padding) : this(DEF_ENCODING_TABLE, padding) { }

        /// <summary>
        /// 构造函数
        /// </summary>
        /// <param name="encodingTable"></param>
        public GoogleBase32Encoder(string encodingTable) : this(encodingTable, DEF_PADDING) { }
        ...
        /// <param name="encodingTable"></param>
        /// <param name="padding"></param>
        public GoogleBase32Encoder(string encodingTable, char padding)
        {
