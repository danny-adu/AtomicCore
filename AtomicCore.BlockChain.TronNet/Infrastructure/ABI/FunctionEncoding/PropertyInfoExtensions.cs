...
namespace AtomicCore.BlockChain.TronNet
{
    ...
    public static class PropertyInfoExtensions
    {
        ...
        public static bool IsHidingMember(this PropertyInfo self)
        {
            ...
            MethodInfo baseMethodDefinition = baseProperty.GetMethod.GetRuntimeBaseDefinition();
            MethodInfo thisMethodDefinition = self.GetMethod.GetRuntimeBaseDefinition();
