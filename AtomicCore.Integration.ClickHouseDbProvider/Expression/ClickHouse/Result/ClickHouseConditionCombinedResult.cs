...
namespace AtomicCore.Integration.ClickHouseDbProvider
{
    ...
    /// </summary>
    internal class ClickHouseConditionCombinedResult : ResultBase
    {
        #region Construtors
        ...
        /// 构造函数
        /// </summary>
        public ClickHouseConditionCombinedResult()
            : base()
        {
        ...
        /// </summary>
        /// <returns></returns>
        public static ClickHouseConditionCombinedResult Create()
        {
            return new ClickHouseConditionCombinedResult();
        }
