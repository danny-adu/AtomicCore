...
namespace AtomicCore.Integration.ClickHouseDbProvider
{
    ...
    /// Mssql语句解析结果集
    /// </summary>
    internal sealed class ClickHouseSentenceResult : ResultBase
    {
        #region Variable
        ...
        /// 构造函数
        /// </summary>
        private ClickHouseSentenceResult()
            : base()
        {
        ...
        private List<ClickHouseSelectField> _sqlSelectFields = null;
        ...
        private List<ClickHouseParameterDesc> _sqlQuerylParameters = null;
        ...
        /// Sql查询中出现的需要查询的字段
        /// </summary>
        public IEnumerable<ClickHouseSelectField> SqlSelectFields
        {
            get
            {
        ...
        /// Sql查询中出现的参数集合
        /// </summary>
        public IEnumerable<ClickHouseParameterDesc> SqlQuerylParameters
        {
            get
            {
        ...
        /// </summary>
        /// <returns></returns>
        public static ClickHouseSentenceResult Create()
        {
            return new ClickHouseSentenceResult();
        }
        ...
        public void SetWhereCondition(string whereText, IEnumerable<ClickHouseParameterDesc> parameters = null)
        {
