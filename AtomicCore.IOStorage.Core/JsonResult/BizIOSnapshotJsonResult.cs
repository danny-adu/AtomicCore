...
namespace AtomicCore.IOStorage.Core
{
    ...
    /// 远程下载快照并且返回快照信息
    /// </summary>
    public class BizIOSnapshotJsonResult : BizIOBaseJsonResult
    {
        #region Constructors
        ...
        /// 构造函数
        /// </summary>
        public BizIOSnapshotJsonResult() : base() { }

        /// <summary>
        /// 构造函数（错误）
        /// </summary>
        /// <param name="errorMsg"></param>
        public BizIOSnapshotJsonResult(string errorMsg) : base(errorMsg)
        {
